...
output_folder = "plots/sample_20_z_tests"
...
path = r"\\AMIPC045962\Cache (D)\daily_data\spectra\20250926 - Sample 20 Z tests"
...
spectra_data_ref, spectra_params_ref = filter_spectra(spectra_data, spectra_params, "*5um*", average=False, exclude=["*bias*", "*baseline*"])
