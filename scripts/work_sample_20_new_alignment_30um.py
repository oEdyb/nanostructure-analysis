...
output_folder = r"plots/sample_20_new_alignment_30um"
...
spectra_path = r"\\AMIPC045962\Cache (D)\daily_data\spectra\20251113 - Sample 20 new reference holes and white laser defocus"
reference_path = r"\\AMIPC045962\Cache (D)\daily_data\spectra\20251113 - Sample 20 new reference holes and white laser defocus"
...
#spectra_data_raw, spectra_params_raw = filter_spectra(spectra_data_raw, spectra_params_raw, "*[A-D]*", average=True, exclude=["*bias*", "*baseline*", "*100ms*", "*FVB*", "*bad*", "*zlock*", "*270nm*"])
spectra_data_raw, spectra_params_raw = filter_spectra(spectra_data_raw, spectra_params_raw, "*[A-D]*zlock*", average=True, exclude=["*bias*", "*baseline*", "*100ms*", "*FVB*", "*bad*", "*270nm*"])
spectra_data_raw, spectra_params_raw = filter_spectra(spectra_data_raw, spectra_params_raw, "*[A-D]*white*", average=True, exclude=["*bias*", "*baseline*", "*100ms*", "*FVB*", "*bad*", "*270nm*"])
spectra_data_white, spectra_params_white = filter_spectra(spectra_data_ref, spectra_params_ref, "*30um*_3*", average=False, exclude=["*bias*", "*baseline*", "*270nm*", "*30um_zlock_3*"])
spectra_data_270nm, spectra_params_270nm = filter_spectra(spectra_data_ref, spectra_params_ref, "*30um*_3*", average=False, exclude=["*bias*", "*baseline*", "*270nm*"])

spectra_data = normalize_against_reference(spectra_data_raw, spectra_data_270nm)
...
plot_spectra(spectra_data_270nm, spectra_params_270nm, cutoff=1000, new_fig=True)
plt.savefig(os.path.join(output_folder, "spectra_data_normalized_reference.png"))
plt.close()

plot_spectra(spectra_data_white, spectra_params_white, cutoff=1000, new_fig=True)
plt.savefig(os.path.join(output_folder, "spectra_data_normalized_reference.png"))
plt.close()
