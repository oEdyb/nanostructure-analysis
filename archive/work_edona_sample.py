...
output_folder = r"plots/edona_sample"
os.makedirs(output_folder, exist_ok=True)

def normalize_against_reference(spectra_dict, reference_dict, lam=1e6, p=0.5):
...
spectra_path = r"\\AMIPC045962\Cache (D)\daily_data\spectra\20251007CaM"
...
spectra_data_raw, spectra_params_raw = filter_spectra(spectra_data_raw, spectra_params_raw, "*", average=False, exclude=["*bias*", "*baseline*", "*_1"])
