...
output_folder = r"plots/sample_20_10.24"
...
spectra_data, spectra_params = filter_spectra(spectra_data, spectra_params, "*rod*", average=False, exclude=["*bias*", "*baseline*", "*100ms*", "*FVB*"])
...
for key in spectra_data.keys():
    ...
    spectra_data[key][:, 1] = baseline_als(spectra_data[key][:, 1], 1e7, 0.5)
