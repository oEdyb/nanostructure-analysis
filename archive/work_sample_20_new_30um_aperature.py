...
output_folder = r"plots/sample_20_new_30um_aperature"
...
spectra_path = r"\\AMIPC045962\Cache (D)\daily_data\spectra\20251113 - Sample 20 new reference holes"
reference_path = r"\\AMIPC045962\Cache (D)\daily_data\spectra\20251113 - Sample 20 new reference holes"
...
spectra_data_ref, spectra_params_ref = filter_spectra(spectra_data_ref, spectra_params_ref, "*30um*_3*", average=False, exclude=["*bias*", "*baseline*", "*270nm*"])
